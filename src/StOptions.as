package
{
	...
	public class StOptions extends ZState
	{
		...
		override public function createObjects():void {
			...
			var buttonDataArray:Array = new Array(new Array(toggleSoundReaction,"sound on?"),
				new Array(toggleMusicReaction,"music on?"));
		...
		// Button Reactions
		private function toggleSoundReaction():void {
			//goTo(MapState);
		}
		private function toggleMusicReaction():void {
			//goTo(OptionsState);
		}
	}
}